...
def myshow_lidar(path, idx):
    ...
    dtype=np.float32
    n_vec=4
    pc_velo=utils.load_velo_scan(lidar_filename, dtype, n_vec)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="My Lidar Visualization")
    parser.add_argument(
        "-d",
        "--dir",
        type=str,
    ...
    parser.add_argument("--mylidarvis", action="store_true", help="show lidar visualization")#new add
    ...
    if args.mylidarvis:
        myshow_lidar(args.dir, args.ind)
#     if args.pred:
